...
table = 'WindServer_rhi'
db_name = 'G:/WindOnWeb/db.sqlite3'
db_conn = sqlite3.connect(db_name)
db_cursor = db_conn.cursor()

dest_path = 'G:/WindOnWeb/WindServer/static/data/rhi/湖里/'
...
for file in sub_files:
    ...
    sql_statement = "INSERT INTO " + table + "(azi,station,date_time,img_src) VALUES (" + azi + ",'" + station + "','" + date_time + "','" + img_src +"')"
