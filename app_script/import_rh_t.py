...
dest_path = 'G:/WindOnWeb/WindServer/static/data/T&RH/同安/'
...
for file in sub_files:
    ...
    if sections[1].lower() == 'rh':
        table = 'WindServer_humiditymonth'
    elif sections[1].lower() == 't':
        table = 'WindServer_tempmonth'
    else:continue
