...
table = 'WindServer_windrosemonth'
db_name = 'G:/WindOnWeb/db.sqlite3'
db_conn = sqlite3.connect(db_name)
db_cursor = db_conn.cursor()

dest_path = 'G:/WindOnWeb/WindServer/static/data/WD_AveMo/集美/'
...
for file in sub_files:
    ...
    sql_statement = "INSERT INTO " + table + "(hei,station,date_from,date_to,img_src) VALUES (" + hei + ",'" + station + "','" + dt_from + "','" + dt_to + "','" + img_src +"')"
