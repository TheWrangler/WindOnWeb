...
urlpatterns = [
    ...
    path('ppi/<ele>/<station>/',views_lidar.ppi_update,name='ppi_update'),
    ...
    path('cappi/<hei>/<station>/',views_lidar.cappi_update,name='cappi_update'),
    ...
    path('wind_thi/<direction>/<station>/',views_lidar.windthi_update,name="windthi_update"),
    ...
    path('rhi/<azi>/<station>/',views_lidar.rhi_update,name="rhi_update"),
